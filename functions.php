...
function Saki_scripts()
{
    if (akina_option('jsdelivr_cdn_test')) {
        ...
        wp_enqueue_script('js_lib', 'https://cdn.jsdelivr.net/gh/mashirozx/Saki@' . Saki_VERSION . '/cdn/js/lib.min.js', array(), Saki_VERSION, true);
    }
    if (akina_option('app_no_jsdelivr_cdn')) {
        ...
        wp_enqueue_style('saukra_css', 'https://cdn.jsdelivr.net/gh/mashirozx/Saki@' . Saki_VERSION . '/style.min.css', array(), Saki_VERSION);
        wp_enqueue_script('app', 'https://cdn.jsdelivr.net/gh/mashirozx/Saki@' . Saki_VERSION . '/js/Saki-app.min.js', array(), Saki_VERSION, true);
    }
