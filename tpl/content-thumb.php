	...
	<article class="post post-list-thumb <?php echo $class; ?>" itemscope="" itemtype="http://schema.org/BlogPosting">
		...
		<div class="post-content-wrap">
			<div class="post-content">
				...
				<div class="post-meta">
					<span><i class="iconfont icon-attention"></i><?php echo get_post_views(get_the_ID()).' '._n('Hit','Hits',get_post_views(get_the_ID()),'Saki')/*热度*/?></span>
					<span class="comments-number"><i class="iconfont icon-mark"></i><?php comments_popup_link('NOTHING', '1 '.__("Comment","Saki")/*条评论*/, '% '.__("Comments","Saki")/*条评论*/); ?></span>
